...
namespace DatingApp.API.Data
{
  public class DatingRepository : IDatingRepository
  {
    ...
    {
      return await _context.Likes.FirstOrDefaultAsync(k => k.LikerId == userId && k.LikeeId == recipientId);
    }
    ...
    public async Task<PagedList<User>> GetUsers(UserParams userParams)
    {
      ...
      //Todo: Is there a better way of relating many to many in entity framework?
